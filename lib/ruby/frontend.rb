...
module CoCoTeX
  class Frontend < Thor
    ...
    class_option :temp_dir, type: :string, required: false, desc: "verbosity level", default: "temp", group: "Path", banner: "PATH"
    class_option :log_dir, type: :string, required: false, desc: "path to the directory where log files should be stored", default: "log", group: "Path", banner: "PATH"
