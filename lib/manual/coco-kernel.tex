\begin{Heading}{chapter}
  \Title{coco-kernel.sty}
  \Subtitle{The {\CoCoTeX} Kernel module}
...
In this section, we discuss dive deeper into how to declare custom
Containers and go through the user-facing {\CoCoTeX} kernel macros.
